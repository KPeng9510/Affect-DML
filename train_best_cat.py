...
class OneShotTester(BaseTester):
    ...
    def do_knn_and_accuracies(self, accuracies, embeddings_and_labels, split_name, tag_suffix=''):
        ...
        #shape = knn_labels.shape
        #knn_labels = np.random.randint(7,13, shape)
...
def train_app(cfg):
    ...
    experiment_name = "resnet50_emolevel_66_random_re512_stepsize_10_%s_model_%s_cl_%s_ml_%s_miner_%s_mix_ml_%02.2f_mix_cl_%02.2f_resize_%d_emb_size_%d_class_size_%d_opt_%s_lr_%02.2f_m_%02.2f_wd_%02.2f"%(cfg.dataset.name,
